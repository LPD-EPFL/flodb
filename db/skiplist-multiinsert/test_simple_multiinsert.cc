...
#define DS_ADD(s,k,v,seq)         sl_add(s, k, v, seq)
#define DS_REMOVE(s,k,t)          sl_remove(s, k)
#define DS_SIZE(s)                sl_set_size(s)
#define DS_NEW()                  sl_set_new()
#define DS_MULTI_INSERT(s,k,v,seq,n,r)    sl_multi_insert(s,k,v,seq,n,r)
