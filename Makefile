...
clean:
	-rm -f $(PROGRAMS) $(BENCHMARKS) $(LIBRARY) $(SHARED) $(MEMENVLIBRARY) */*.o */*/*.o */*/*/*.o ios-x86/*/*.o ios-arm/*/*.o build_config.mk
...
simple_example: examples/simple_example.o $(LIBOBJECTS) $(TESTHARNESS)
	$(CXX) $(LDFLAGS) examples/simple_example.o $(LIBOBJECTS) $(TESTHARNESS) -o $@ $(LIBS)
...
rcu_test: util/rcu_test.o $(LIBOBJECTS) $(TESTHARNESS)
	$(CXX) $(LDFLAGS) util/rcu_test.o $(LIBOBJECTS) $(TESTHARNESS) -o $@ $(LIBS)

memtable_test: db/memtable_test.o $(LIBOBJECTS) $(TESTHARNESS)
	$(CXX) $(LDFLAGS) db/memtable_test.o $(LIBOBJECTS) $(TESTHARNESS) -o $@ $(LIBS)

clht_test: db/clht/clht_test.o $(LIBOBJECTS) $(TESTHARNESS)
	$(CXX) $(LDFLAGS) db/clht/clht_test.o $(LIBOBJECTS) $(TESTHARNESS) -o $@ $(LIBS)

skiplist_herlihy_test: db/skiplist_herlihy_multiinsert/skiplist_herlihy_test.o $(LIBOBJECTS) $(TESTHARNESS)
	$(CXX) $(LDFLAGS) db/skiplist_herlihy_multiinsert/skiplist_herlihy_test.o $(LIBOBJECTS) $(TESTHARNESS) -o $@ $(LIBS)

skiplist_multiinsert_test: db/skiplist-multiinsert/test_simple_multiinsert.o $(LIBOBJECTS) $(TESTHARNESS)
	$(CXX) $(LDFLAGS) db/skiplist-multiinsert/test_simple_multiinsert.o $(LIBOBJECTS) $(TESTHARNESS) -o $@ $(LIBS)

membuffer_test: db/membuffer_test.o $(LIBOBJECTS) $(TESTHARNESS)
	$(CXX) $(LDFLAGS) db/membuffer_test.o $(LIBOBJECTS) $(TESTHARNESS) -o $@ $(LIBS)

comparator_test: util/comparator_test.o $(LIBOBJECTS) $(TESTHARNESS)
	$(CXX) $(LDFLAGS) util/comparator_test.o $(LIBOBJECTS) $(TESTHARNESS) -o $@ $(LIBS)
